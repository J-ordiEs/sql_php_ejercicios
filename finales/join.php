...
$sql = 'SELECT user.*, status.name, user_type.name as type_name FROM user INNER JOIN status ON user.status_id = status.id INNER JOIN user_type ON user_type.id = user.user_type_id';
...
$sql_log = 'SELECT * FROM user LEFT JOIN user_log ON user.id = user_id';
